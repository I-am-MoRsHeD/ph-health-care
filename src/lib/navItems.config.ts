...
export const getCommonNavItems = (role: UserRole): ISidebarNavSection[] => {
...
export const doctorNavItems: ISidebarNavSection[] = [
    {
...
export const patientNavItems: ISidebarNavSection[] = [
    {
        title: "Appointments",
        items: [
            {
...
export const adminNavItems: ISidebarNavSection[] = [
    {
...
export const getNavItemsByRole = (role: UserRole): ISidebarNavSection[] => {
